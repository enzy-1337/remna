...
ADMIN_NAV_ITEMS: tuple[tuple[str, str, str, str | None], ...] = (
    ...
    ("/admin/devices", "fa-solid fa-mobile-screen-button", "Устройства", "view_users"),
...
def required_permission_for_request(method: str, path: str) -> str | None:
    ...
    if m != "GET" and (
        ...
        or p.startswith("/admin/mass-grant")
    ):
        return "edit_subscriptions"
    ...
    rules: tuple[tuple[str, str], ...] = (
        ...
        ("/admin/mass-grant", "edit_subscriptions"),
