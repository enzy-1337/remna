"""Привязка пользователя к forum topic для downloader-бота."""
...
class DownloaderUserTopic(Base):
    __tablename__ = "downloader_user_topics"
    __table_args__ = (
        UniqueConstraint("forum_chat_id", "topic_id", name="uq_downloader_forum_topic"),
    )
