    ...
    (
        ...
        [
            ...
            (
                ...
                "Отдельный выключатель, как у триала: false — не начислять welcome ГБ даже если BILLING_FIRST_TOPUP_WELCOME_GB > 0.",
            ),
            (
                "BILLING_FIRST_TOPUP_WELCOME_GB",
                "Сколько ГБ в welcome-бонусе",
                lambda s: str(s.billing_first_topup_welcome_gb),
                "ГБ к лимиту Remnawave при первом успешном пополнении, если не было активной подписки; 0 — без бонуса по сумме.",
            ),
        ],
    ),
    (
